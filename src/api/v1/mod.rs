...
pub async fn handle_basic_get<Table: for<'a> sqlx::FromRow<'a, sqlx::postgres::PgRow> + serde::Serialize>(rows_request: Result<Vec<sqlx::postgres::PgRow>, sqlx::Error>,connection: sqlx::pool::PoolConnection<sqlx::Postgres>,) -> HttpResponse {
